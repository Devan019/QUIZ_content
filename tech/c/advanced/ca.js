...
n3.addEventListener("click", (e) => {
   ...
   if(a3){
    if (a3.value == "constant or an expression") total++;
   }
}
)
...
n5.addEventListener("click", (e) => {
   ...
   if(a5){
    if (a5.value == "paranthesis & comma") total++;
   }
       ...
       let b = document.createElement("button");
        ...
        b.innerHTML = `<a href="cadvans.html">NEXT >></a>`;
            ...
            r.classList.add("showresult0"); 
             r.innerHTML = `<a href = "cadvans.html">Show Answers</a>`;
                 con.after(r);
