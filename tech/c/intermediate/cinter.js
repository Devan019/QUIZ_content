...
n7.addEventListener("click", (e) => {
   ...
   if(a7){
    if (a7.value == "pointer to file object") total++;
   }
...
submit.addEventListener("click", (e) => {
   ...
   if(a10){
    if (a10.value == "The program will execute normally") total++;
   }
   ...
   if (total >= 1) {
     ...
     Congratulations!! You have cleared the C-Language Intermediate Level test
     <br><br>
 ...
 let b = document.createElement("button");
  ...
  b.innerHTML = `<a href="../c-bia.html">NEXT >></a>`;
      ...
      r.classList.add("showresult0"); 
       r.innerHTML = `<a href = "cintans.html">Show Answers</a>`;
           con.after(r);
   //    b.addEventListener("click",(e)=>{
   //       window.open("cadvans.html");
   //   })
   }
      else{
      sorry.classList.remove("hide");
      sorry.classList.add("sorryy");
      sorry.innerHTML = `Oops! You could not clear the C-Language Intermediate level test`;
      let b = document.createElement("button");
      
      b.classList.add("finalbutton");
      b.innerHTML = `<a href="../c-bia.html.html">NEXT>></a>`;
      sorry.after(b);
      let r = document.createElement("button");
   ...
   if(j == -1){
      if(i == -1){
         ...
         if (total >= 1) {   
            ...
            con.innerHTML = `<div class="container">
           Congratulations!! You have cleared the C-Language Intermidate Level test
           <br><br>
           <p>Your Score : ${total}/10</p>
       </div>`
       let b = document.createElement("button");
        ...
        b.innerHTML = `<a href="../c-bia.html.html">NEXT >></a>`;
            ...
            let r = document.createElement("button");
            r.classList.add("showresult0"); 
             r.innerHTML = `<a href = "cintanss.html">Show Answers</a>`;
                 con.after(r);
            clearInterval(inter);
            ...
            sorry.innerHTML = `Oops! You could not clear the C-Language Intermidate level test`;
            let b = document.createElement("button");
            b.classList.add("finalbutton");
            b.innerHTML = `<a href="../c-bia.html">NEXT >></a>`;
            sorry.after(b);
