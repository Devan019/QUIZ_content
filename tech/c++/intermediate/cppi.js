...
n5.addEventListener("click", (e) => {
   ...
   if(a5){
    if (a5.value == "call by reference") total++;
   }
...
n6.addEventListener("click", (e) => {
   ...
   if(a6){
    if (a6.value == "Friend Constructor") total++;
   }
...
n9.addEventListener("click", (e) => {
   ...
   if(a9){
    if (a9.value == "pointer with asterisk") total++;
   }
...
submit.addEventListener("click", (e) => {
 ...
 let b = document.createElement("button");
  ...
  b.innerHTML = `<a href="../c++-bia.html">NEXT >></a>`;
      ...
      r.innerHTML = `<a href = "cppians.html">Show Answers</a>`;
      con.after(r);
            clearInterval(inter);
