...
n1.addEventListener("click", (e) => {
   ...
   if (a1) {
      console.log(a1);
      if (a1.value == "Bjarne Stroustrup") total++;
   }
...
submit.addEventListener("click", (e) => {
   ...
   if (a10) {
      if (a10.value == "All of the above") total++;
   }
   ...
   if (total >= 1) {
     ...
     <p>Your Score : ${total}/10</p>
      ...
      r.innerHTML = `<a href = "cppbans.html">Show Answers</a>`;
      con.after(r);
      clearInterval(inter);
