...
submit.addEventListener("click", (e) => {
   ...
   if (total >= 1) {
     ...
     Congratulations!! You have cleared the CSS Advanced Level test
     <br><br>
 ...
 let b = document.createElement("button");
  ...
  let r = document.createElement("button");
      ...
      r.innerHTML = `<a href = "cssaans.html">Show Answers</a>`;
      con.after(r);
      ...
      sorry.innerHTML = `Oops! You could not clear the CSS Advanced level test`;
      let b = document.createElement("button");
