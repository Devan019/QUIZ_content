...
n4.addEventListener("click", (e) => {
   ...
   if(a4){
    if (a4.value == "Top,Right,Bottom,Left") total++;
   }
...
n5.addEventListener("click", (e) => {
   ...
   if(a5){
    if (a5.value == "outline-style") total++;
   }
...
n6.addEventListener("click", (e) => {
   ...
   if(a6){
    if (a6.value == "All of the above") total++;
   }
...
n9.addEventListener("click", (e) => {
   ...
   if(a9){
    if (a9.value == "A mathematical expression") total++;
   }
...
submit.addEventListener("click", (e) => {
   ...
   if(a10){
    if (a10.value == "box-reflect") total++;
   }
   ...
   if (total >= 1) {
     ...
     Congratulations!! You have cleared the CSS Beginner Level test
     <br><br>
 ...
 let b = document.createElement("button");
  ...
  b.innerHTML = `<a href="../css-bia.html">NEXT >></a>`;
      con.after(b);

      let r = document.createElement("button");
      r.classList.add("showresult0");
      r.innerHTML = `<a href = "cssbans.html">Show Answers</a>`;
      con.after(r);
   }
      else{
      sorry.classList.remove("hide");
      sorry.classList.add("sorryy");
      sorry.innerHTML = `Oops! You could not clear the CSS Beginner level test`;
      let b = document.createElement("button");
