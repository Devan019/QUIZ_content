...
submit.addEventListener("click", (e) => {
   ...
   if (total >= 1) {
     ...
     Congratulations!! You have cleared the CSS Intermediate Level test
     <br><br>
 ...
 let b = document.createElement("button");
  ...
  b.innerHTML = `<a href="../css-bia.html">NEXT >></a>`;
      ...
      r.innerHTML = `<a href = "cssians.html">Show Answers</a>`;
      con.after(r);
   }
      else{
      sorry.classList.remove("hide");
      sorry.classList.add("sorryy");
      sorry.innerHTML = `Oops! You could not clear the CSS Intermediate level test`;
      let b = document.createElement("button");
